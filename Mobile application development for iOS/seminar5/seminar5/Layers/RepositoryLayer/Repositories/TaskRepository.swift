...
final class TaskRepositoryImpl: TaskRepository {
    ...
    private(set) var tasks: [Task] = [
        Task(id: 1,
             ...
             description: "Plan all tasks and assign story points for the upcoming sprint with the team.",
        ...
        Task(id: 2,
             ...
             description: "Start the day with a short yoga and breathing session to improve focus.",
        ...
        Task(id: 3,
             ...
             description: "Investigate and fix the crash occurring during token refresh on background fetch.",
        ...
        Task(id: 4,
             ...
             description: "Pick up vegetables, fruit, dairy and snacks for the week.",
             dueDate: makeDate(2026, 3, 17),
        ...
        Task(id: 5,
             ...
             description: "Go through saved WWDC session notes and highlight key SwiftUI updates.",
        ...
        Task(id: 6,
             ...
             description: "Routine dental checkup and cleaning at the clinic.",
        ...
        Task(id: 7,
             ...
             description: "Extract business logic from the view, apply MVVM properly and add unit tests.",
        ...
        Task(id: 8,
             ...
             description: "Keep up the weekly running habit to maintain fitness and clear the mind.",
             dueDate: makeDate(2026, 3, 18),
        ...
        Task(id: 9,
             ...
             description: "Gather all income documents and submit the annual tax return online.",
        ...
        Task(id: 10,
             ...
             description: "Complete the remaining modules on animations and custom transitions.",
